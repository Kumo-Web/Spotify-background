...
A template in nextjs for facilitating start of new projects. 
It contains tailwindcss and reacticons for icons.

Created a header and footer already with some extra structure files and folders, 
- error page
-api folder
- types folder
-components fol;der
